...
export type SystemPurposeId = 'Catalyst' | 'Custom' | 'Designer' | 'Developer' | 'DeveloperPreview' | 'Executive' | 'Generic' | 'Scientist' | 'YouTubeTranscriber' | 'Translator';
...
{{RenderSVG}}`.trim(),
  ...
  Translator: {
    ...
    systemMessage: 'You are an expert translator proficient in both English and Chinese. Your task is to translate the following English text into Chinese, or Chinese text into English, with the highest level of accuracy. Please ensure that the translation:\n' +
      '\n' +
    ...
    symbol: '📚',
    examples: ['Help me translate this context from English to Chinese as accurate as possible', '你是个非常专业的翻译官，能准确地将中文翻译成英文，请帮我翻译如下内容：'],
    // call: { starters: ['Enter a YouTube URL to begin.', 'Ready to transcribe YouTube content.', 'Paste the YouTube link here.'] },
    // voices: { elevenLabs: { voiceId: 'z9fAnlkpzviPz146aGWa' }
  },
